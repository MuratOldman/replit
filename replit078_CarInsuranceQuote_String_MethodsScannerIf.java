...
public class replit078_CarInsuranceQuote_String_MethodsScannerIf {
    public static void main(String[] args) {
        ...
        System.out.println("Reference number: "+name.substring(0,2)+age+name.substring(name.length()-2,name.length())
